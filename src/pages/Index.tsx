  ...
  return (
    <div className="min-h-screen bg-background p-8 flex flex-col gap-4">
      ...
      <pre className="p-4 bg-muted rounded overflow-auto text-xs whitespace-pre-wrap max-w-full">
        {`pq meu dashboard esta com diagnostico do sistema. agora voltou mas os disparou parou de funcionar . PostgreSQL Database directory appears to contain a database; Skipping initialization
